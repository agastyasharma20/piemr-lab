...
import { Cable, Zap, RefreshCw, Cpu, ExternalLink, HelpCircle } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <motion.div custom={4} variants={fadeUp} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1rem' }}>
        {COA_VIDEOS['io-organization'].refs?.map((ref, i) => (
      ...
      <motion.div custom={5} variants={fadeUp} className="glass-panel-md" style={{ padding: '2.5rem', borderTop: '4px solid var(--warning)' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: '0.88rem', marginBottom: '1.5rem' }}>I/O and DMA questions from GATE & technical interviews.</p>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
          {COA_VIDEOS['io-organization'].interviewQs?.map((q, i) => (
      ...
      <YouTubePiP
        videoId={COA_VIDEOS['io-organization'].videoId}
        videoTitle={COA_VIDEOS['io-organization'].videoTitle}
